...
**3-Day Plan**
- Sunday, 26 Jul: Rest — fever-free day 3, the final day of the count
- Monday, 27 Jul: If cleared, your first step back is a gentle WALK (not a run) — short and easy, just testing the waters. If not quite there, one more rest day is the right call.
...
**This week's focus**
With roughly 9 weeks still ahead of 27 Sep, this week's only real job is a complete, unhurried recovery — that protects every training week still to come. Once cleared: gentle walks first, then very short easy runs (with a caring eye on that left shin), and some light Norway-prep leg strength waiting once your body gives the green light. You're handling this beautifully — rest well, the race isn't going anywhere.
