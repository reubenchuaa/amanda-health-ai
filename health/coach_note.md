...
- Monday, 27 Jul: If cleared, your first step back is a gentle WALK (not a run) — short and easy, just testing the waters. If not quite there yet, one more rest day is exactly the right call.

**This week's focus**
With roughly 9 weeks still ahead of 27 Sep, this week's only real job is a full, unhurried recovery — that's what protects every training week still to come. Once you're cleared: gentle walks first, then very short easy runs (with a caring eye on that left shin), and some light Norway-prep leg strength waiting in the wings once your body gives the green light. You're handling this beautifully — rest well, the race isn't going anywhere.
